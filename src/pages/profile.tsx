  ...
  return (
    <div className="relative">
      ...
      <main className="text-center max-w-[87.5rem] mx-auto">
        <div>
          <header className="mt-[23rem] mb-[18.8rem]">
          ...
          <section>
            ...
            <div className="flex justify-center">
              <div className="max-w-[43.75rem]">
                <div className="text-sm py-2 px-3 leading-[1.2em] bg-[#F3F2F1] rounded-full inline-flex mt-[8.75rem] mb-[1.25rem]">
                  About
                </div>
                <div className="text-[2.375rem] leading-[2.875rem] mb-[13.65rem]">
            ...
            <div>
              <header>
                <div className="text-sm py-2 px-3 leading-[1.2em] bg-[#F3F2F1] rounded-full inline-flex">
                  Experience
                </div>
                <div className="text-[2.375rem] leading-[2.875rem] mt-[0.64rem] mb-[7.4rem]">
                  Where I&apos;ve worked
                </div>
              </header>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-y-[5rem] mx-auto mb-[9.5rem]">
                <div>
                  <div className="space-y-[0.57rem]">
                    <div className="text-[#828282] text-sm">2017 — Present</div>
                ...
                <div>
                  <div className="space-y-[0.57rem]">
                    <div className="text-[#828282] text-sm">2021 — Present</div>
            ...
            <div>
              <header>
                ...
                <div className="text-[2.375rem] leading-[2.875rem] mt-[0.65rem] mb-[7rem]">
                  Who I&apos;ve worked with
                </div>
              </header>
              <div>
                <div className="grid grid-cols-2 md:grid-cols-4 justify-items-center gap-y-[5.2rem] px-[2.25rem]">
                  <img
