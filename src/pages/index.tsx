      ...
      <FadeInOnScroll>
        <div className="relative">
          <div className="absolute z-10">
            ...
            <div className="fixed left-1/2 right-1/2 flex items-center justify-center bottom-[1.88rem] text-white text-sm fadeIn">
              <a
                href="http://oh.supply/"
          ...
          <main>
            <section className="flex items-center justify-center">
              <header className="flex flex-col items-center justify-center max-w-[700px] text-center h-[70vh] mt-28 mb-10">
                <h1 className="text-[4.575rem] leading-[86px] tracking-[-0.012em] fadeIn">
                  A brand and product designer working with clients globally
                </h1>
                <div className="flex gap-[0.575rem] mt-[2.5rem] fadeInSlow">
